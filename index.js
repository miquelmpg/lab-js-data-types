...
const charA = part1[part1.length -1].toUpperCase();
const charT = part2[part2.length -1].toUpperCase();

const partJav = part1.substring(0, part1.length - 1);
const partScrip = part2.substring(0, part2.length - 1);

const result = partJav + charA + partScrip + charT;
